...
//   console.log("Fetching messages 1");
//   try {
...
//       console.log("Loaded API key prefix:", process.env.OPENAI_API_KEY?.substring(0, 10));

//       if (!openaiApiKey || openaiApiKey === 'your_openai_api_key_here') {
//         assistantContent = `This is a simulated response. Please configure your OPENAI_API_KEY in the .env file.`;
//         tokensUsed = 50;
//       } else {
//         // ✅ Official OpenAI SDK request
...
//           max_tokens: 500,
//         });
//         console.log("Sending request of .....", completion);
...
//         console.error("OpenAI API Axios Error:", error.response?.data || error.message);
//       } else if (error instanceof Error) {
//         console.error("OpenAI SDK Error:", error.message);
//       } else {
//         console.error("Unexpected error:", error);
//       }
//       console.log("data:",assistantContent);
